...
function checkSubjectName() {
	...
	*/
	 $.ajax({
		url : 'doCreateSubject.jsp?type=check&id='+<%=id%>+'&subjectName='+encodeURI(encodeURI(subjectName)),
...
<!--doCreatePaper.jsp-->
	$(document).ready(function() {
		$("#submit").click(function() {
			...
			if(flag){
				$.ajax({
					url : 'doCreateSubject.jsp?type=update&id='+<%=id%>+'&subjectName='+encodeURI(encodeURI(subjectName)),
					type : "GET",
					contentType : "application/json;charset=utf-8",
					success : function(data) {
						//alert(data);
...
<body style="text-align: center;">
	<div style="float: left;">
		<table class="table table-bordered"
			...
			<tr>
				<td align="right"><font style="font-size: 18px;">科目ID</font></td>
				<td width="340px;"><input type="text" id="id" readonly="readonly"
					name="id" class="myinput" value=<%=id %>></input></td>
			</tr>
			<tr>
				<td align="right"><font style="font-size: 18px;">科目名称</font></td>
				<td width="340px;"><input type="text" id="subjectName"
					name="subjectName" class="myinput" onBlur="checkSubjectName()" value=<%=subjectName %>></input></td>
			</tr>
			<tr>
				<td colspan="2">
					<div align="center">
						<input id="submit" type="button" style="margin-right: 40px;" class="btn btn-success" name="ok" value="修改">
