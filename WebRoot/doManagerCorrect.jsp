...
<html>
  ...
  <body>
    ...
    try{
    	...
    	String in_phone=request.getParameter("phone");
    	sql="update manager set userName=?,password=?,phone=? where id="+in_id;
    	ps=conn.prepareStatement(sql);
    	ps.setString(1,in_userName);
    	ps.setString(2,in_password);
    	ps.setString(3,in_phone);
    	ps.executeUpdate();
    	}catch(Exception e){
    		e.printStackTrace();
    	}
     %>
     <jsp:forward page="manageMEFor.jsp"></jsp:forward>
  </body>
</html>
